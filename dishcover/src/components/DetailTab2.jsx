      ...
      <div className="detail-body">
        ...
        <div className="friend-visited">
          <div className="friend-avatars">
            ...
            <div className="friend-avatar" style={{ background: 'var(--green100)', color: 'var(--green600)' }}>MK</div>
          </div>
          <div className="friend-visited-text">Jihyun, Soyeon and Minkyu visited · "The broth is amazing"</div>
        </div>
